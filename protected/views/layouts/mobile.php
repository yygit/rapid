...
<div data-role="page">
    ...
    <!--<div data-role="collapsible" data-content-theme="a">-->
        ...
        /*// $non_mobile_uri = preg_replace('/mobile=on/', 'mobile=off', '/site/login');
    ...
    if (count($this->menu) > 0) {
        ...
        foreach ($this->menu as $key=>$item) {
            $this->menu[$key]['linkOptions'] = !empty($this->menu[$key]['linkOptions']) ? $this->menu[$key]['linkOptions'] : array();
            $this->menu[$key]['linkOptions'] = CMap::mergeArray($this->menu[$key]['linkOptions'], $linkOptions);
        }
        $this->widget('zii.widgets.CMenu', array(
            'items'=>$this->menu,
            'htmlOptions'=> $htmlOptions,
